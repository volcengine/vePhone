...
public class MainActivity extends BaseListActivity {
    ...
    protected void setupAdapter(ItemsHolder holder) {
        ...
        holder.addItem(R.string.message_channel, R.string.message_channel_desc, MessageChannelActivity.class, Feature.FEATURE_CAMERA);
        holder.addItem(R.string.pod_control, R.string.pod_control_desc, PodControlServiceActivity.class, Feature.FEATURE_CAMERA);
