...
const FIELD_LABELS: Record<MobileField, string> = {
  ...
  max_step: "MaxStep",
  timeout_seconds: "任务超时 Timeout（秒）",
...
const REQUEST_HEADERS_PLACEHOLDER = '{"X-Env":"test","X-Request-Source":"cua"}';
  ...
  return (
    <div className="settings-page">
      <PageHeader
        ...
        title="设置"
        description="管理个人偏好、通知策略和 Computer Use Agent 运行配置。"
        actions={
          isAdmin ? (
            <button
        ...
        <div className="settings-card">
          ...
          {isAdmin && (
            <section className="settings-section" id="defaults">
              <div className="section-heading">
                <div className="section-header">
                  ...
                  <p className="section-desc">
                    默认使用 Computer Use Agent。密钥只支持覆盖更新，不会回填原值。
                  </p>
                </div>
              ...
              <div className="settings-grid">
                {CUA_FIELDS.map((field) => renderInput(
                  field,
