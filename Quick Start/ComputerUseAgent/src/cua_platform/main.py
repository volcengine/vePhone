...
from cua_platform.api.auth import router as auth_router
from cua_platform.api.body_limit import RequestBodyLimitMiddleware
from cua_platform.api.business import router as business_router
from cua_platform.api.cases import router as cases_router
from cua_platform.api.diagnostics import router as diagnostics_router
from cua_platform.api.novnc import router as novnc_router
from cua_platform.api.errors import error_detail
from cua_platform.api.pods import router as pods_router
from cua_platform.api.settings import router as settings_router
from cua_platform.api.tasks import router as tasks_router
from cua_platform.api.tasks import testing_router
from cua_platform.api.test_plans import router as test_plans_router
from cua_platform.api.traces import router as traces_router
from cua_platform.auth.throttle import LoginThrottle
from cua_platform.business.models import BusinessSpace as _BusinessSpace  # noqa: F401
from cua_platform.config import Settings, get_settings
...
from cua_platform.runners.mobile_use import MobileUseRunner, RunRequestLoader
...
error_logger = logging.getLogger("cua_platform.errors")
...
def create_app(
    ...
    *,
    ...
    app.state.novnc_proxy_store = NoVncProxyStore()
